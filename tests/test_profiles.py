...
from src.providers.profile.profile_generator import RandomProfileGenerator
from src.providers.profile.profile_generator import NatProfileGenerator
from src.providers.profile.profile_generator import Profile
from src.constants.names import dutch_surnames, dutch_female_firstnames
from src.constants.names import dutch_male_firstnames
...
class TestProfiles(TestCase):
    ...
    def test_it_generates_mostly_unique_items(self):
        ...
        for _ in range(5):
            ...
            name = prof.first_name + " " + prof.initial if prof.initial \
                else "" + " " + prof.last_name
    ...
    def test_it_generates_expected_nationality_name(self):
        ...
        self.assertIn(
            test_profile.first_name, dutch_male_firstnames +
